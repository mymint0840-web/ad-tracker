...
import type { Product, AdAccount } from '@/types';
...
export function DateFilter({ accounts, products }: DateFilterProps) {
  const { dateFilter, accountFilter, productFilter, setDateFilter, setAccountFilter, setProductFilter, resetFilters } = useFilterStore();
